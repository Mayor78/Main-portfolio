        ...
        <div className="bg-black text-gray-400 h-[100px] max-w-[1200px] mx-auto flex justify-between items-center">
            ...
            <div ref={navRef} className={nav ? 'z-10 fixed h-[50%] left-0 top-0 w-[60%] bg-[#202121] ease-in-duration-500' : 'fixed left-[100%] '}>
                ...
                <ul className='p-8 text-2xl'>
                    <li className='p-2 hover:text-white hover:underline'><a href="#home" onClick={handleLinkClick}>Home</a></li>
                    <li className='p-2 hover:text-white hover:underline'><a href="#about" onClick={handleLinkClick}>About</a></li>
                    <li className='p-2 hover:text-white hover:underline'><a href="#work" onClick={handleLinkClick}>Work</a></li>
                    <li className='p-2 hover:text-white hover:underline'><a href="#contact" onClick={handleLinkClick}>Contact</a></li>
                </ul>
            </div>
        </div>
    );
