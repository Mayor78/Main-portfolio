  ...
  return (
    <div className='border-gray-400 text-gray-400 md:h-[150px] max-w-[1200px] mx-auto grid grid-cols-6
                place-items-center md:flex md:justify-between md:items-center'>
                    ...
                    <div className="flex flex-col items-center m-4 sm:my-0 w-[50px] md:w-[100px]  hover:-translate-y-1 hover:animate-shake transition-allduration-400 opacity-90">
                        <img src={html} alt="" />
                        <p className="mt-2 md:hidden text-transparent hover:text-white">HTML</p>

                    </div>

                    <div className="flex flex-col items-center m-4 sm:my-0 w-[50px] md:w-[100px]  hover:-translate-y-1 hover:animate-shake transition-all duration-400 opacity-90">
                        <img src={css} alt="" />
                        <p className="mt-2 md:hidden text-transparent hover:text-white">CSS</p>

                    </div>

                    <div className="flex flex-col items-center m-4 sm:my-0 w-[50px] md:w-[100px]  hover:-translate-y-1 hover:animate-shake transition-all duration-400 opacity-90">
                        <img src={javascript} alt="" />
                        <p className="mt-2 md:hidden text-transparent hover:text-white">JAVASCRIPT</p>

                    </div>

                    <div className="flex flex-col items-center m-4 sm:my-0 w-[50px] md:w-[100px]  hover:-translate-y-1 hover:animate-shake transition-all duration-400 opacity-90">
                        <img src={tailwind} alt="" />
                        <p className="mt-2 md:hidden text-transparent hover:text-white">TAILWIND</p>

                    </div>

                    <div className="flex flex-col items-center m-4 sm:my-0 w-[50px] md:w-[100px] hover:-translate-y-1 hover:animate-shake transition-all durat opacity-90">
                        <img src={react} alt="" />
                        <p className="mt-2 md:hidden text-transparent hover:text-white">REACT</p>
